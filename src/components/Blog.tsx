    ...
    <section id="blog" className="py-32 px-8 lg:px-20 bg-[#070706]">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2
            className="text-[#f0ede8] font-black leading-[1.05] mb-3"
            style={{
        ...
        <div>
          {posts.map((post, i) => (
            <motion.article
              ...
              className="border-t border-[#2a2520] py-10 group cursor-default hover:bg-[#080706] transition-colors duration-300 px-4 -mx-4"
            >
